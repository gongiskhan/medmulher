...
if($_POST)
{
	...
	$subject        = 'Medix - New Appointment Request'; //Subject line for emails
	...
	$app_date     = filter_var($_POST["app_date"], FILTER_SANITIZE_STRING);
	}
	...
	$message_Body .= "<strong>Appointment Date: </strong>". $app_date ."<br>";
